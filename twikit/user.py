...
class User:
    ...
    def __init__(self, client: Client, data: dict) -> None:
        self._client = client
        # X frequently omits fields it once guaranteed and has begun moving some
        # into a sibling ``core`` object, so every access below is defensive
        # (see d60/twikit issues #417, #420, #425). ``core`` wins when present.
        ...
        self.urls: list = (entities.get('url') or {}).get('urls') or []
